...
export default function TimeOffRequestModal({ onClose }) {
    ...
    const handleSave = () => {
        ...
        const payload = {
          ...
          total_days: calculateRequestedDays(),
          total_hours: calculateRequestedDays() * 8, // optional: adjust if you use hour system
          note: note.trim()
        };
      
        console.log("Submitting payload:", payload);
        // Replace with API call
        // axios.post("/api/leave-request", payload)
        //   .then(...)
      };
    ...
    return (
        ...
        <div
          className={`relative w-full max-w-screen-2xl h-[90vh] bg-white rounded-t-2xl shadow-lg flex flex-col ${
            isClosing ? 'animate-shrinkToBottom' : 'animate-growFromBottom'
          }`}
        >
          {/* Header */}
          <div className="sticky top-0 bg-white px-4 sm:px-6 md:px-8 py-4 border-b flex items-center justify-between flex-wrap gap-2 sm:gap-0 rounded-t-2xl">
