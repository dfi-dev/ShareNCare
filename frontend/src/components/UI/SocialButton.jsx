...
const SocialButton = () => {
    return <div className="flex justify-center space-x-3 mt-3">
        ...
        <button className="group relative flex items-center justify-center bg-white text-gray-800 rounded-xl text-sm font-medium px-4 py-3 w-fit transition-all duration-300 shadow-sm hover:shadow-md border border-gray-200">
